<template>
    <svg>
        <polygon  :points="calculateTriangle(drawing, imageWidth, imageHeight)"
            :fill="getFillColor(drawing)" :stroke="getStrokeColor(drawing)"
            :stroke-width="(drawing.strokeWidth === 0) ? 1 : drawing.strokeWidth + '%'" :opacity="drawing.alpha / 255"
            :transform="'rotate(' + drawing.angle + ' ' +
...
export default {
    ...
    calculateTriangle: function (drawing,
